...
function WebTrends(){
	...
	this.dcsid=(function(){var domlist="test.nationalarchives.gov.uk,dev.nationalarchives.web.local,devtest.nationalarchives.web.local,website.web.local,reddot.tna.local";var doms=that.dcsSplit(domlist);var dlen=doms.length;var host=window.location.hostname.toLowerCase();for (var i=0;i<dlen;i++){if (host==doms[i]){return("dcsv1gbn510000gkmz735s9or_5k5r");}}return("dcsdhhxq6000004rry7ab39or_9h9r");})();
	this.domain="smartsource.nationalarchives.gov.uk";
	this.timezone=0;
	this.fpcdom="";
	this.onsitedoms=(function(){return(window.RegExp?new RegExp("nationalarchives","i"):"");})();
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,mp3,swf,xml,mp4,wmv";
...
WebTrends.prototype.dcsFPC=function(){
	...
	var dExp=new Date(dCur.getTime()+63113904000);
