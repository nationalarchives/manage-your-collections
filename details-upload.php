                        ...
                        <form action="" method="post">
                            ...
                            <div class="grid-within-grid-three-item clr" id="mapping">
                                <div id="discovery-fields"><!-- start grid one -->
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="legal_status" name="discovery_field" value="Legal status" value="legal_status">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="language" name="discovery_field" value="Language" value="language">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="reference" name="discovery_field" value="Reference">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="former_reference_dept" name="discovery_field" value="Former reference (department)">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="former_reference_pro" name="discovery_field" value="Former reference (PRO)">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="map_designation" name="discovery_field" value="Map designation">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="creator_name" name="discovery_field" value="Creator name">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="physical_desc_extent" name="discovery_field" value="Physical description, extent">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="physical_desc_form" name="discovery_field" value="Physical description, form">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="map_scale_number" name="discovery_field" value="Map scale number">
                                ...
                                <div id="custom-fields"><!-- start grid two -->
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="user_legal_status" name="user_field" value="Legal status">
                                        <label for="user_legal_status">Legal status</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_language" name="user_field" value="Language">
                                        <label for="user_language">Language</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_reference" name="user_field" value="Reference">
                                        <label for="user_reference">Reference</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_former_reference_dept" name="user_field" value="Former reference (department)">
                                        <label for="user_former_reference_dept">Former reference (department)</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_former_reference_pro" name="user_field" value="Former reference (PRO)">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="user_map_designation" name="user_field" value="Map designation">
                                        <label for="user_map_designation">Map designation</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_creator_name" name="user_field" value="Creator name">
                                        <label for="user_creator_name">Creator name</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_covering_dates" name="user_field" value="Covering dates">
                                        <label for="user_covering_dates">Covering dates</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_physical_desc_extent" name="user_field" value="Physical description, extent">
                                        <label for="user_physical_desc_extent">Physical description, extent</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_physical_desc_form" name="user_field" value="Physical description, form">
                                        <label for="user_physical_desc_form">Physical description, form</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_dimensions" name="user_field" value="Dimensions">
                                        <label for="user_dimensions">Dimensions</label>
                                    </div>
                                    <div class="data-item">
                                        <input type="radio" id="user_map_scale_number" name="user_field" value="Map scale number">
