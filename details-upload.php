                                ...
                                <div id="custom-fields"><!-- start grid two -->
                                    ...
                                    <div class="data-item">
                                        ...
                                        <div class="definition" id="def_user_insititution_name">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum malesuada venenatis sollicitudin. Phasellus a nibh quis lectus sagittis scelerisque. Proin maximus vitae massa eget tristique. Vivamus sit amet ante eu turpis accumsan malesuada. Donec purus dui, rhoncus sit amet venenatis ac, tempor non dui.</p>
                                        </div>
                                    </div>
                                    <div class="data-item">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="user_access_category_notes" name="user_field" value="access_category.notes">
                                    ...
                                    <div class="data-item">
                                        <input type="radio" id="user_environment_condition_notes" name="user_field" value="environmental_condition.notes">
